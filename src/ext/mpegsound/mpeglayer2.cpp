...
{ 0.0f,        1.0f/2.0f,    1.0f/4.0f,    1.0f/8.0f,
  ...
  1.0f/2048.0f, 1.0f/4096.0f, 1.0f/8192.0f, 1.0f/16384.0 };
...
{ 0.0f,        1.0f/2.0f,    1.0f/4.0f,     1.0f/8.0f, 
  ...
  1.0f/4096.0f, 1.0f/8192.0f, 1.0f/16384.0f, 1.0f/32768.0 };
...
static const REAL factortableB4[4] = { 0.0f, 1.0f/2.0f, 1.0f/4.0f, 1.0f/32768.0f };
...
{           0.0f, 1.33333333333f, 1.14285714286f, 1.06666666666f,
  ...
  1.00012208522f, 1.00006103888f, 1.00003051851f, 1.00001525902f};
static const REAL ctableB2[16] =
{           0.0f, 1.33333333333f, 1.60000000000f, 1.14285714286f,
  1.77777777777f, 1.06666666666f, 1.03225806452f, 1.01587301587f,
  1.00787401575f, 1.00392156863f, 1.00195694716f, 1.00097751711f,
...
{           0.0f, 0.50000000000f, 0.25000000000f, 0.12500000000f,
  ...
  0.00024414063f, 0.00012207031f, 0.00006103516f, 0.00003051758f};

static const REAL dtableB2[16]=
{ 0.0f,           0.50000000000f, 0.50000000000f, 0.25000000000f,
  0.50000000000f, 0.12500000000f, 0.06250000000f, 0.03125000000f,
  0.01562500000f, 0.00781250000f, 0.00390625000f, 0.00195312500f,
...
// Read Sample
  {
	...
	if(inputstereo && bitalloc[RS][i])
	{
	  ...
	  {
	    fraction[RS][0][i]=
	      REAL(getbits(codelength[RS][i]))*factor[RS][i]-1.0f;
	    fraction[RS][1][i]=
	      REAL(getbits(codelength[RS][i]))*factor[RS][i]-1.0f;
	    fraction[RS][2][i]=
	      REAL(getbits(codelength[RS][i]))*factor[RS][i]-1.0f;
	...
	if(bitalloc[LS][i])
	{
	  ...
	  else
	  {
	    fraction[LS][0][i]=fraction[RS][0][i]=
	      REAL(getbits(codelength[LS][i]))*factor[LS][i]-1.0f;
