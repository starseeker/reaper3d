...
#define MPEGSOUND_API __declspec(dllexport)
#else
#define MPEGSOUND_API __declspec(dllimport)
...
class MPEGSOUND_API Soundinputstream
{
public:
  Soundinputstream() 
...
class MPEGSOUND_API Soundplayer
{
public:
...
private:
  ...
  static const REAL hcos_64[16];
  static const REAL hcos_32[8];
  static const REAL hcos_16[4];
  static const REAL hcos_8[2];
  static const REAL hcos_4;
