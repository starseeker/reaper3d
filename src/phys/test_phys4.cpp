...
//                cout << "ObjectPair: Eneven sim_times!" << obj1.sim_time-obj2.sim_time << endl;
	...
	void ObjectPair::collide(const Collision& col)
	{
		...
		//v4 �r nya normalhastigheten f�r obj2;
		//v3 �r nya normalhastigheten f�r obj1;
		...
		//Nu adderar vi lite rotationer ocks�, f�r skojs skull
		//Detta g�rs genom en fulformel. 
		//Antag en kontakttid p� 1 hundradels sekund

		//Kontaktpunkten kommer att p�verkas av en kraft som ligger
